          ...
          setTimeout(function() {
            ...
            setTimeout(function() {
              ...
              fields.forEach(function(f) {
                f.classList.remove(errorClass, successClass);
              });
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '591ae372-d56e-405a-9b47-2b82705eda8b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '591ae372-d56e-405a-9b47-2b82705eda8b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '591ae372-d56e-405a-9b47-2b82705eda8b';
